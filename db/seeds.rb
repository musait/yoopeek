...
if User.all.empty?
   ...
   User.create!([
    ...
    {  confirmed_at: Time.now.utc,approved: true,email: 'a@a.com', firstname: 'John', lastname: 'Doe', is_worker: false, type: 'Customer', nationality: 'French', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nisl ex, ornare accumsan enim in, ultricies venenatis risus. Vivamus sagittis est consectetur molestie molestie.', password:"password"},
    {  confirmed_at: Time.now.utc,approved: true,email: 'c@c.com', firstname: 'Friedrich', lastname: 'Nikla', is_worker: false, type: 'Customer', nationality: 'German', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nisl ex, ornare accumsan enim in, ultricies venenatis risus. Vivamus sagittis est consectetur molestie molestie.', password:"password"},
    {  confirmed_at: Time.now.utc,approved: true,email: 'd@d.com', firstname: 'Patrick', lastname: 'Onatenpa',is_worker: false, type: 'Customer', nationality: 'French', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nisl ex, ornare accumsan enim in, ultricies venenatis risus. Vivamus sagittis est consectetur molestie molestie.', password:"password"},
    {  confirmed_at: Time.now.utc,approved: true,email: 'b@b.com', firstname: 'Will', lastname: 'Pioneer',is_worker: true, type: 'Worker',profession_id: Profession.first.id,price_rate: '40', nationality: 'English', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nisl ex, ornare accumsan enim in, ultricies venenatis risus. Vivamus sagittis est consectetur molestie molestie.', password:"password"},
    {  confirmed_at: Time.now.utc,approved: true,email: 'e@e.com', firstname: 'Fabrice', lastname: 'Lagarde',is_worker: true, type: 'Worker',profession_id: Profession.second.id, price_rate: '60', nationality: 'French', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nisl ex, ornare accumsan enim in, ultricies venenatis risus. Vivamus sagittis est consectetur molestie molestie.', password:"password"},
    {  confirmed_at: Time.now.utc,approved: true,email: 'f@f.com', firstname: 'Will', lastname: 'Smoth',is_worker: true, type: 'Worker',profession_id: Profession.first.id,price_rate: '30', nationality: 'English', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nisl ex, ornare accumsan enim in, ultricies venenatis risus. Vivamus sagittis est consectetur molestie molestie.', password:"password"}
    ])
