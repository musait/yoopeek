...
if User.all.empty?
   ...
   User.create!([
    {  confirmed_at: Time.now.utc,approved: true,email: 'yoopeek@yoopeek.com', firstname: 'Yoopeek', lastname: 'Yoopeek', type: 'Worker',price_rate: '', nationality: '', description: '', password:"password"},
