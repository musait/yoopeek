class Quote < ApplicationRecord
  ...
  def send_notification_and_email
    case self.status
      ...
      when "declined"
        Notification.create!(message: I18n.t('.quotes.decline.your_quote_has_been_declined',job: self.job.name), quote: self, created_for: self.class.to_s.underscore, sender: self.receiver, receiver: self.sender)
